    ...
    <center>
        <table style='width:700px; font-size:12pt; font-family:calibri; border-collapse: collapse;' border='0'>
            ...
            <td width='70%' align='left' style='padding-right:80px; vertical-align:top'>
                <img src="<?php echo base_url() . 'assets/kop_insan.png' ?>" alt="" height=100 width=300></img>
        ...
        <table cellspacing='0' style='width:700px; font-size:12pt; font-family:calibri;  border-collapse: collapse; margin-top:5pt;' border='0'>
            ...
            <tr>
                ...
                <td style='text-align:right;' width='15%'>Rp 34500,00</td>
            </tr>
            <!-- <tr>
                <td colspan='5'>
                    <div style='text-align:right;font-weight:bold'>Total Keseluruhan : </div>
                </td>
                <td style='text-align:right;font-weight:bold' width='15%'><?= rupiah($g_total)  ?></td>
            </tr> -->
