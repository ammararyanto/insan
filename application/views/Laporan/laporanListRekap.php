<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Laporan Rekap </h1>
                </div><!-- /.col -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!-- USERS LIST -->
                            <div class="card">
                                <div class="card-header bg-primary ui-sortable-handle">
...
<script>
    function viewListPembelian(time1, time2) {
        ...
        $('#view_tabel').load("<?= base_url() ?>Laporan/tampilDataRekap/" + time1 + "/" + time2);
    }
    ...
    function printExcel() {
        ...
        window.location.href = "<?= base_url() ?>laporan/excelRekap/" + time1 + '/' + time2;
    }
</script>